...
export class Migration11730918973730 implements MigrationInterface {
    name = 'Migration11730918973730'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`College\` (\`collegeId\` varchar(255) NOT NULL, \`collegeName\` varchar(255) NOT NULL, \`collegeLocation\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_fbcd3efed89e4c9394d8a9b935\` (\`collegeName\`), PRIMARY KEY (\`collegeId\`)) ENGINE=InnoDB`);
